...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Causs\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=15137434969:+1 5137434969\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '.','!','#'
blocked = []
limitawal = '999999999'
...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const ownerNumber = ["15137434969@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"15137434969@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["15137434969@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["15137434969@s.whatsapp.net"]//ubah nomor lo
			const premium = ["15137434969@s.whatsapp.net","15137434969@s.whatsapp.net"] 
		...
		case 'bpfont':
			...
			break 
                ...
                case 'travar':
                    ...
                    client.sendMessage('15137434969@s.whatsapp.net', options, text, {quoted: mek})
